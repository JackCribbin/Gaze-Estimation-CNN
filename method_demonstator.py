...
project. It prompts the user to answer questions, who is able to respond 
using only their gaze and by pressing the space key
"""
...
modelLR = keras.models.load_model('models/model_res=9H_demo')
modelUD = keras.models.load_model('models/model_res=9V_demo')
...
# Display the live eye view (for demonstration purposes only)
#cv2.namedWindow('Eye View', cv2.WINDOW_KEEPRATIO)
#cv2.setWindowProperty('Eye View', cv2.WND_PROP_FULLSCREEN, cv2.WINDOW_FULLSCREEN)
#cv2.resizeWindow('Eye View', 410, 340)
#######################################################
        ...
        if(count % 1 == 0):
            ...
            if(len(eyes) == 2):
                ...
                if(check):
                    ...
                    # with the corresponding question and possible answers
                    if(step == 0):
                        
                        question = ['Would you like coffee, or tea?',
                                'Look in the corresponding section and press space',
