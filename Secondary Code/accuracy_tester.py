...
try:
    ...
    while loop:
        ...
        # Display a dot at a random point on the screen
        x_act = random.randint(0,1920)
        y_act = random.randint(0,1080)
        ...
        if loop:
            ...
            if(check == False):
                print('Please keep your eyes within the green region')
            ...
            if(len(eyes) == 2):
                ...
                if(check):
                    ...
                    x_guess, y_guess = displayGuess(size, score, res, scoreLR, scoreUD)
