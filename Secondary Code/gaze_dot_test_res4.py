...
x = size[0]/2 - (size[0]/2 * score[0]) + (size[0]/2 * score[1]) - (size[0]/2 * score[2]) + (size[0]/2 * score[3])
y = size[1]/2 + (size[1]/2 * score[0]) + (size[1]/2 * score[1]) - (size[1]/2 * score[2]) - (size[1]/2 * score[3])
